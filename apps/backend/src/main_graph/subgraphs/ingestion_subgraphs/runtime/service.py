"""Runtime analysis service — business logic extracted from the analyze node."""
...
async def analyze_service(
    ...
    """Run runtime analysis: download, identify scripts, execute in Docker, persist."""
    ...
    cached = await cache_dao.find_cached_entry(
    ...
    try:
        ...
        try:
            await cache_dao.upsert_cached_entry(
                RuntimeCacheEntry(
