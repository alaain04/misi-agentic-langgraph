...
Detailed tool sets, system prompts, and output schemas for Stage 2 and Stage 3 are in separate spec files to be brainstormed and implemented independently:

- **Stage 2:** [2026-05-17-stage2-impact-design.md](2026-05-17-stage2-impact-design.md) — `impact` subgraph
- **Stage 3:** [2026-05-17-stage3-synthesis-design.md](2026-05-17-stage3-synthesis-design.md) — `risk_ranker`, `risk_score`, `recommendation`

In the current implementation plan these nodes are scaffolded as stubs with the correct interfaces. Full implementation follows from those specs.
